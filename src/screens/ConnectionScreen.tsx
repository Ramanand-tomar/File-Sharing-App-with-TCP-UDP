...
const ConnectionScreen: FC = () => {
  ...
  const renderThumnail = (mimeType: string) => {
    switch (mimeType) {
      ...
      case '.jpg':
        return (
          <Icon name="image" size={16} color="orange" iconsFamily="Ionicons" />
        );
      case '.pdf':
        return (
          <Icon name="document" size={16} color="red" iconsFamily="Ionicons" />
        );
      default:
        return (
          <Icon name="folder" size={16} color="grey" iconsFamily="Ionicons" />
        );
    }
  };
              ...
              <View style={connectionStyles.sendReceiveButtonContainer}>
                ...
                >
                  <Icon
                    name="cloud-upload"
                    size={12}
                    color={activeTab === 'SENT' ? 'green' : 'grey'}
                    iconsFamily="Ionicons"
                  />
                  <CustomText
                    numberOfLines={1}
            ...
            {(activeTab === 'SENT'
              ...
              <View style={connectionStyles.noDataContainer}>
                <CustomText
                  ...
                  fontSize={11}
                >
                  {activeTab === 'SENT' ? 'No sent files' : 'No received files'}
                </CustomText>
              </View>
            )}
          </View>
